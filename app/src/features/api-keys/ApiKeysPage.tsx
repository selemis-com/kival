        ...
        <div style={styles.modalBackdrop} role="presentation">
          ...
          >
            <div style={styles.modalCopy}>
              ...
              <p style={styles.muted}>
                Any CLI, agent, or automation using this key will lose access immediately. Your
                passkey will be requested before the key is revoked.
              </p>
            </div>
            <div style={styles.modalActions}>
              <button
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    setError(passkeyActionError(cause, "Could not revoke API key."));
                  } finally {
                    setRevoking(false);
                  }
                }}
