...
`createKivalClient` binds the complete action set to the client.
...
Interactive browser authentication, passkeys, sessions, API-key management, and workspace creation are intentionally not part of the public client. Those operations require a Kival browser session and belong to the Kival web application.
