...
pub use wire::{
    ...
    SearchMode, SearchParams, SearchResponse, SearchTermCoverage, Session, SessionListResponse,
    SessionOnlyResponse, Status, StatusResponse, UpdateApiKeyRequest, UpdateCommentRequest,
