...
#![doc(
    html_logo_url = "https://raw.githubusercontent.com/selemis-com/kival/master/.github/assets/logo.jpg",
    html_favicon_url = "https://raw.githubusercontent.com/selemis-com/kival/master/.github/assets/favicon.ico"
)]
...
pub use wire::{
    ...
    PinState, RealtimeMessage, ReuseObjectAttachmentRequest, SearchCategory, SearchHit,
    SearchMatchKind, SearchMode, SearchParams, SearchResponse, SearchTermCoverage, Session,
    ...
    UserResponse, UserStatus, WhoamiResponse, Workspace, WorkspaceGraphEdge, WorkspaceGraphLimits,
